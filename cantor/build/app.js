...
var $author$project$Block$Internal$Component$Body$diskIndexes = function (_v0) {
	var cols = _v0.a;
	var rows = _v0.b;
...
var $author$project$Block$Internal$Component$Body$diskClass = F2(
	function (cols, colIdx) {
		var tens = 10 * ((cols / 10) | 0);
		var fives = tens + (5 * (((cols - tens) / 5) | 0));
		return (_Utils_cmp(colIdx, tens) < 1) ? 'disk-ten' : ((_Utils_cmp(colIdx, fives) < 1) ? 'disk-five' : 'disk-one');
	});
...
var $author$project$Block$Internal$Component$Body$viewDisk = F4(
	function (vm, vd, _v0, _v1) {
		var cols = _v0.a;
		var rows = _v0.b;
		var colIdx = _v1.a;
		var rowIdx = _v1.b;
		var _v2 = _Utils_Tuple2(vm.grid.unit, vm.grid.unit / 2);
		var unit = _v2.a;
		var halfUnit = _v2.b;
		var pos = A2(
			...
			A2(
				$author$project$Pos$add,
				A2($author$project$Pos$Pos, -halfUnit, -halfUnit),
				A2(
					$author$project$Pos$scale,
					unit,
					$author$project$Pos$fromInt(
						_Utils_Tuple2(colIdx, rowIdx)))));
		var radius = unit / 2.5;
		return A2(
			$elm$svg$Svg$circle,
			_List_fromArray(
				[
					...
					A2($author$project$Block$Internal$Component$Body$diskClass, cols, colIdx)),
...
var $author$project$Block$Internal$Component$Body$viewDisks = F3(
	function (vm, vd, _v0) {
		var cols = _v0.a;
		var rows = _v0.b;
		return A2(
			$elm$core$List$map,
			A3(
				$author$project$Block$Internal$Component$Body$viewDisk,
				vm,
				vd,
				_Utils_Tuple2(cols, rows)),
			$author$project$Block$Internal$Component$Body$diskIndexes(
				_Utils_Tuple2(cols, rows)));
	});
...
var $author$project$Block$Internal$Component$Body$viewRect = F2(
	function (vm, vd) {
		...
		var rows = _v0.b;
		var disks = A3(
			$author$project$Block$Internal$Component$Body$viewDisks,
			vm,
			vd,
			_Utils_Tuple2(cols, rows));
		var txt = A3(
