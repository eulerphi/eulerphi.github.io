...
var $author$project$Board$none = {boardSize: 0, headerHeight: 0, panelHeight: 0, panelWidth: 0, squareSize: 0, style: ''};
...
var $author$project$Board$fromViewContext = F2(
	function (board, vc) {
		...
		return _Utils_update(
			board,
			{boardSize: boardSize, headerHeight: headerHeight, panelHeight: panelHeight, panelWidth: panelWidth, squareSize: squareSize});
	});
...
var $author$project$View$logStep = F3(
	function (m, idx, step) {
		var text = (_Utils_cmp(idx, m.idx) < 0) ? A2(
			$elm$core$Maybe$withDefault,
			'',
			A2(
				$elm$core$Maybe$map,
...
var $author$project$View$sidebarButton = F3(
	function (msg, text, isSelected) {
...
var $author$project$View$leftBar = function (m) {
	return A3(
		...
		A2(
			...
			_List_fromArray(
				[
					A3($author$project$View$sidebarButton, $author$project$Model$PrevMove, '<', false),
					A3($author$project$View$sidebarButton, $author$project$Model$NextMove, '>', false)
				])));
};
...
var $author$project$View$rightBar = function (m) {
	return A3(
		...
		A2(
			...
			A2(
				$elm$core$List$cons,
				A3($author$project$View$sidebarButton, $author$project$Model$Clear, 'x', false),
				A2(
					$elm$core$List$cons,
					A2(
						$elm$html$Html$hr,
					...
					A2(
						...
						function (_v0) {
							...
							var mode = _v0.b;
							return A3(
								$author$project$View$sidebarButton,
						...
						_List_fromArray(
							[
								_Utils_Tuple2('AR', $author$project$Model$Arrowing),
								_Utils_Tuple2('MA', $author$project$Model$Marking),
								_Utils_Tuple2('MO', $author$project$Model$Moving)
							]))))));
};
...
_Platform_export({'Main':{'init':$author$project$Main$main($elm$json$Json$Decode$value)({"versions":{"elm":"0.19.1"},"types":{"message":"Model.Msg","aliases":{"Square.Square":{"args":[],"type":"Internal.Square.Square"},"Browser.Dom.Viewport":{"args":[],"type":"{ scene : { width : Basics.Float, height : Basics.Float }, viewport : { x : Basics.Float, y : Basics.Float, width : Basics.Float, height : Basics.Float } }"}},"unions":{"Model.Msg":{"args":[],"tags":{"NoOp":[],"Clear":[],"ClickSquare":["Square.Square"],"NextMove":[],"PrevMove":[],"SelectMode":["Model.Mode"],"ViewCtxMsg":["ViewContext.Msg"]}},"Model.Mode":{"args":[],"tags":{"Arrowing":[],"Marking":[],"Moving":[]}},"ViewContext.Msg":{"args":[],"tags":{"NoOp":[],"ViewportChanged":["Browser.Dom.Viewport"],"WindowResized":[]}},"Internal.Square.Square":{"args":[],"tags":{"Square":["Basics.Int"]}},"Basics.Float":{"args":[],"tags":{"Float":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}}}}})}});}(this));