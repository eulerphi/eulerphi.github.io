...
var $author$project$Input$Input = F3(
	function (seed, showAnswer, word) {
		return {seed: seed, showAnswer: showAnswer, word: word};
	});
var $elm$json$Json$Decode$bool = _Json_decodeBool;
var $author$project$Input$decoder = A4(
	$elm$json$Json$Decode$map3,
...
var $author$project$Input$decode = function (value) {
	...
	if (_v0.$ === 'Ok') {
		...
		return {seed: 0, showAnswer: true, word: 'error'};
	}
};
...
var $author$project$Tile$Tile = F3(
	function (id, letter, pos) {
		return {id: id, letter: letter, pos: pos};
	});
var $author$project$Tile$toId = function (idx) {
	return 'tile-' + $elm$core$String$fromInt(idx);
};
var $author$project$Coord$Coord = F2(
	function (x, y) {
		return {x: x, y: y};
	});
var $author$project$Tile$toPos = function (idx) {
	return A2($author$project$Coord$Coord, idx * 72, 0);
};
var $author$project$Tile$toTile = F2(
	function (idx, letter) {
		return A3(
			$author$project$Tile$Tile,
			$author$project$Tile$toId(idx),
			letter,
			$author$project$Tile$toPos(idx));
	});
var $author$project$Tile$fromWord = function (word) {
	return A2(
		$elm$core$List$indexedMap,
		$author$project$Tile$toTile,
...
var $author$project$Tile$updatePos = F2(
	function (idx, tile) {
		return _Utils_update(
			tile,
			{
				pos: $author$project$Tile$toPos(idx)
			});
	});
var $author$project$Tile$shuffle = F2(
	function (seed, tiles) {
		var ts = $elm$core$Array$fromList(tiles);
		return A2(
			$elm$core$List$indexedMap,
			$author$project$Tile$updatePos,
			$elm$core$Array$toList(
				A2(
					$elm$random$Random$step,
					$elm_community$random_extra$Random$Array$shuffle(ts),
					seed).a));
	});
var $author$project$Model$init = function (input) {
	var seed = $elm$random$Random$initialSeed(input.seed);
	var ts = input.showAnswer ? $author$project$Tile$fromWord(input.word) : A2(
		$author$project$Tile$shuffle,
		seed,
		$author$project$Tile$fromWord(input.word));
	return {active: $elm$core$Maybe$Nothing, drag: $zaboco$elm_draggable$Draggable$init, tiles: ts, word: input.word};
};
...
var $author$project$Coord$addX = F2(
	function (c, dx) {
		return _Utils_update(
			c,
			{x: c.x + dx});
	});
var $author$project$Msg$DragMove = function (a) {
	return {$: 'DragMove', a: a};
};
var $author$project$Msg$EndDrag = {$: 'EndDrag'};
var $author$project$Msg$StartDrag = function (a) {
...
var $author$project$Main$dragConfig = $zaboco$elm_draggable$Draggable$customConfig(
	_List_fromArray(
		[
			$zaboco$elm_draggable$Draggable$Events$onDragStart($author$project$Msg$StartDrag),
			$zaboco$elm_draggable$Draggable$Events$onDragBy(
			A2($elm$core$Basics$composeL, $author$project$Msg$DragMove, $author$project$Delta$init)),
			$zaboco$elm_draggable$Draggable$Events$onDragEnd($author$project$Msg$EndDrag)
		]));
...
var $author$project$Tile$roundToIndex = function (tile) {
	var rightIdx = $elm$core$Basics$ceiling(
		A2($elm$core$Basics$max, 1.0, tile.pos.x) / 72);
	var midpoint = tile.pos.x + 31;
	var border = (rightIdx * 72.0) - 5;
	return (_Utils_cmp(midpoint, border) < 0) ? (rightIdx - 1) : rightIdx;
};
...
var $author$project$Model$tiles = function (m) {
	var _v0 = m.active;
	if (_v0.$ === 'Just') {
		var t = _v0.a;
		var activeIdx = $author$project$Tile$roundToIndex(t);
		var indices = A2(
			$elm$core$Debug$log,
			'indices',
			A2(
				...
				function (i) {
					return !_Utils_eq(i, activeIdx);
				},
				A2(
					$elm$core$List$range,
					0,
					$elm$core$String$length(m.word) - 1)));
		var tiles_ = A3($elm$core$List$map2, $author$project$Tile$updatePos, indices, m.tiles);
		var _v1 = _Utils_Tuple2(
			A2($elm$core$List$take, activeIdx, tiles_),
			A2($elm$core$List$drop, activeIdx, tiles_));
		var before = _v1.a;
		var after = _v1.b;
		return _Utils_ap(
			before,
			A2($elm$core$List$cons, t, after));
	} else {
		return m.tiles;
	}
};
...
var $author$project$Main$update = F2(
	function (msg, m) {
		switch (msg.$) {
			...
			case 'DragMsg':
				var subMsg = msg.a;
				return A3($zaboco$elm_draggable$Draggable$update, $author$project$Main$dragConfig, subMsg, m);
			case 'StartDrag':
				var id = msg.a;
				var _v1 = m.active;
				if (_v1.$ === 'Just') {
					...
					var actives = _v2.a;
					var inactives = _v2.b;
					if (actives.b && (!actives.b.b)) {
						var x = actives.a;
						return _Utils_Tuple2(
							_Utils_update(
								m,
								{
									active: $elm$core$Maybe$Just(x),
									tiles: inactives
								}),
							$elm$core$Platform$Cmd$none);
					} else {
			...
			case 'DragMove':
				...
				if (_v4.$ === 'Just') {
					var x = _v4.a;
					var x_ = _Utils_update(
						x,
						{
							pos: A2($author$project$Coord$addX, x.pos, delta.dx)
						});
					return _Utils_Tuple2(
						_Utils_update(
							m,
							{
								active: $elm$core$Maybe$Just(x_)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(m, $elm$core$Platform$Cmd$none);
...
var $author$project$Msg$DragMsg = function (a) {
	return {$: 'DragMsg', a: a};
};
...
var $author$project$Tile$style = function (tile) {
	return _List_fromArray(
		[
			...
			$rtfeldman$elm_css$Css$px(tile.pos.x)),
			...
			$rtfeldman$elm_css$Css$hex('787c7e')),
...
var $author$project$Tile$tileAttrs = function (tile) {
	var touchEvts = A2($zaboco$elm_draggable$Draggable$touchTriggers, tile.id, $author$project$Msg$DragMsg);
	var mouseEvt = A2($zaboco$elm_draggable$Draggable$mouseTrigger, tile.id, $author$project$Msg$DragMsg);
	var evts = A2(
		$elm$core$List$map,
		$rtfeldman$elm_css$Html$Styled$Attributes$fromUnstyled,
		A2($elm$core$List$cons, mouseEvt, touchEvts));
	return A2(
		$elm$core$List$cons,
		$rtfeldman$elm_css$Html$Styled$Attributes$id(tile.id),
		A2(
			$elm$core$List$cons,
			$rtfeldman$elm_css$Html$Styled$Attributes$css(
				$author$project$Tile$style(tile)),
			evts));
};
var $author$project$Tile$view = function (tile) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		$author$project$Tile$tileAttrs(tile),
		_List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$text(
				$elm$core$String$fromChar(tile.letter))
			]));
};
var $author$project$Tile$wordWidth = function (word) {
	return ($elm$core$String$length(word) * 72) - 12;
};
				...
				_List_fromArray(
					[
						...
						$rtfeldman$elm_css$Css$px(
							$author$project$Tile$wordWidth(m.word))),
...
_Platform_export({'Main':{'init':$author$project$Main$main($elm$json$Json$Decode$value)({"versions":{"elm":"0.19.1"},"types":{"message":"Msg.Msg","aliases":{"Delta.Delta":{"args":[],"type":"{ dx : Basics.Float, dy : Basics.Float }"},"Internal.Position":{"args":[],"type":"{ x : Basics.Int, y : Basics.Int }"}},"unions":{"Msg.Msg":{"args":[],"tags":{"NoOp":[],"DragMsg":["Draggable.Msg String.String"],"StartDrag":["String.String"],"DragMove":["Delta.Delta"],"EndDrag":[]}},"Basics.Float":{"args":[],"tags":{"Float":[]}},"Draggable.Msg":{"args":["a"],"tags":{"Msg":["Internal.Msg a"]}},"String.String":{"args":[],"tags":{"String":[]}},"Internal.Msg":{"args":["a"],"tags":{"StartDragging":["a","Internal.Position"],"DragAt":["Internal.Position"],"StopDragging":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}}}}})}});}(this));